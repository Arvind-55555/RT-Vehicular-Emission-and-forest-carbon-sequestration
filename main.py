...
def run_complete_pipeline():
    ...
    try:
        ...
        raw_df = data_acquirer.generate_training_data(
            start_date="2023-01-01", days=180  # 6 months of data
        )
        ...
        feature_columns = [
            col for col in engineered_df.columns if col not in exclude_columns
        ]
