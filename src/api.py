...
def create_feature_dict(data: PolicyInput, apply_policies: bool = False) -> dict:
    ...
    if apply_policies:
        ...
        if data.traffic_reduction_pct > 0:
            ...
            features['avg_speed_kph'] = min(70, features['avg_speed_kph'] / reduction_factor)
        ...
        features['traffic_index_0_100_rolling_mean_7'] = features['traffic_index_0_100'] * 0.95
        features['traffic_index_0_100_rolling_std_7'] = features['traffic_index_0_100'] * 0.1
