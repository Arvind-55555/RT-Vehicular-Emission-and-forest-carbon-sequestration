...
class APIConfig:
    ...
    OPENWEATHER_API_KEY: str = os.getenv("OPENWEATHER_API_KEY", "your_openweather_key")
...
FOREST_COVER_DATA: Dict[str, Dict[str, float]] = {
...
VEHICLE_DATA: Dict[str, Dict[str, float]] = {
    "Delhi": {
        "total_vehicles": 11893.0,
        "car_prop": 0.35,
        "truck_prop": 0.05,
        "twowheeler_prop": 0.55,
    },
    "Mumbai": {
        "total_vehicles": 3876.17,
        "car_prop": 0.30,
        "truck_prop": 0.10,
        "twowheeler_prop": 0.55,
    },
    "Bengaluru": {
        "total_vehicles": 9638.36,
        "car_prop": 0.40,
        "truck_prop": 0.08,
        "twowheeler_prop": 0.48,
    },
    "Chennai": {
        "total_vehicles": 6351.73,
        "car_prop": 0.38,
        "truck_prop": 0.07,
        "twowheeler_prop": 0.50,
    },
    "Kolkata": {
        "total_vehicles": 1024.08,
        "car_prop": 0.32,
        "truck_prop": 0.06,
        "twowheeler_prop": 0.57,
    },
    "Hyderabad": {
        "total_vehicles": 3242.81,
        "car_prop": 0.36,
        "truck_prop": 0.08,
        "twowheeler_prop": 0.52,
    },
    "Pune": {
        "total_vehicles": 3198.83,
        "car_prop": 0.42,
        "truck_prop": 0.09,
        "twowheeler_prop": 0.45,
    },
    "Ahmedabad": {
        "total_vehicles": 4571.19,
        "car_prop": 0.34,
        "truck_prop": 0.08,
        "twowheeler_prop": 0.54,
    },
    "Surat": {
        "total_vehicles": 2800.0,
        "car_prop": 0.33,
        "truck_prop": 0.10,
        "twowheeler_prop": 0.53,
    },
    "Jaipur": {
        "total_vehicles": 3168.34,
        "car_prop": 0.37,
        "truck_prop": 0.07,
        "twowheeler_prop": 0.52,
    },
...
EMISSION_FACTORS: Dict[str, Dict[str, float]] = {
    "CO2": {"car": 150.0, "truck": 450.0, "twowheeler": 80.0},
    "PM25": {"car": 0.005, "truck": 0.05, "twowheeler": 0.002},
    "NOX": {"car": 0.18, "truck": 1.5, "twowheeler": 0.08},
}

# Sequestration factors
SEQUESTRATION_FACTORS: Dict[str, float] = {
